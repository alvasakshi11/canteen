...
<?php
   ...
   if(isset($_POST['submit'])){
     ...
     $sql="UPDATE customer SET customer_id='$customer_id',customer_name='$customer_name' WHERE customer_id='$customer_id'";
     $result=mysqli_query($con,$sql);
     if($result)
     { 
...
.sidenav {
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
     placeholder="Enter employee id" name="customer_id" autocomplete="off" 
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
     placeholder="Enter employee name" name="customer_name" autocomplete="off" 
