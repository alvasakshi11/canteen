...
<?php
   ...
   if(isset($_POST['submit'])){
     ...
     $sql="UPDATE orders SET customer_id='$customer_id',food_name='$food_name',quantity='$quantity' WHERE customer_id=$customer_id";
     $result=mysqli_query($con,$sql);
     if($result)
     { 
...
.sidenav {
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
     placeholder="Enter customer-id=" name="customer_id" autocomplete="off" 
...
<div class="form-group">
    ...
    <input type="text" class="form-control" 
     placeholder="Enter your phone" name="quantity" autocomplete="off" 
